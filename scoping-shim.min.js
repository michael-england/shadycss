...
function Qa(a,b,c,e){var d=a.indexOf(Ra);0<=a.indexOf(Oa)?a=Sa(a,e):0!==d&&(a=c?Ta(a,c):a);c=!1;0<=d&&(b="",c=!0);if(c){var f=!0;c&&(a=a.replace(Ua,function(a,b){return" > "+b}))}-1<a.indexOf(":dir")&&(a=a.replace(Va,function(a,b,c){return'[dir="'+c+'"] '+b+", "+b+'[dir="'+c+'"]'}));return{value:a,H:b,stop:f}}function Ta(a,b){a=a.split(Wa);a[0]+=b;return a.join(Wa)}
function Sa(a,b){if(!a.match(Xa))return a.replace(Oa,b);var c=a.replace(Ya,function(a,c){return b+c});if(c!==a)return c;c=a.replace(Za,function(a,c){return c.split($a)[0]===b?c:ab});return c!==a?c:a.replace(bb,function(a,c){return b+c})}function cb(a){a.selector===db&&(a.selector="html")}I.prototype.c=function(a){return a.match(Ra)?this.b(a,eb):Ta(a.trim(),eb)};aa.Object.defineProperties(I.prototype,{a:{configurable:!0,enumerable:!0,get:function(){return"style-scope"}}});
var Ma=/:(nth[-\w]+)\(([^)]+)\)/,eb=":not(.style-scope)",Ka=",",Pa=/(^|[\s>+~]+)((?:\[.+?\]|[^\s>+~=[])+)/g,$a=/[[.:#*]/,Oa=":host",db=":root",Ra="::slotted",Na=new RegExp("^("+Ra+")"),Xa=/:host\s*?\(/,Ya=/:host\s*\(\s*([[.:#*][^)(]+?)\s*\)/,Za=/:host\s*\(\s*([^[.:#*][^)(]+?)\s*\)(.*)/,bb=/:host\s*\(\s*(.+)\s*\)/,Ua=/(?:::slotted)(?:\(((?:\([^)(]*\)|[^)(]*)+?)\))/,Va=/(.*):dir\((?:(ltr|rtl))\)/,Ja=".",Wa=":",Ha="class",ab="should_not_match",K=new I;function fb(){}
function gb(a){for(var b=0;b<a.length;b++){var c=a[b];if(c.target!==document.documentElement&&c.target!==document.head)for(var e=0;e<c.addedNodes.length;e++){var d=c.addedNodes[e];if(d.nodeType===Node.ELEMENT_NODE){var f=d.getRootNode();var h=d;var g=[];h.classList?g=Array.from(h.classList):h instanceof window.SVGElement&&h.hasAttribute("class")&&(g=h.getAttribute("class").split(/\s+/));h=g;g=h.indexOf(K.a);if((h=-1<g?h[g+1]:"")&&f===d.ownerDocument)J(d,h,!0);else if(f.nodeType===Node.DOCUMENT_FRAGMENT_NODE&&(f=
...
if(!t){var hb=new MutationObserver(gb),ib=function(a){hb.observe(a,{childList:!0,subtree:!0})};if(window.customElements&&!window.customElements.polyfillWrapFlushCallback)ib(document);else{var jb=function(){ib(document.body)};window.HTMLImports?window.HTMLImports.whenReady(jb):requestAnimationFrame(function(){if("loading"===document.readyState){var a=function(){jb();document.removeEventListener("readystatechange",a)};document.addEventListener("readystatechange",a)}else jb()})}fb=function(){gb(hb.takeRecords())}}
var kb=fb;function P(a,b,c,e,d){this.j=a||null;this.b=b||null;this.B=c||[];this.s=null;this.u=d||"";this.a=this.h=this.m=null}function Q(a){return a?a.__styleInfo:null}function lb(a,b){return a.__styleInfo=b}P.prototype.c=function(){return this.j};P.prototype._getStyleRules=P.prototype.c;function mb(a){var b=this.matches||this.matchesSelector||this.mozMatchesSelector||this.msMatchesSelector||this.oMatchesSelector||this.webkitMatchesSelector;return b&&b.call(this,a)}var nb=navigator.userAgent.match("Trident");function ob(){}function pb(a){var b={},c=[],e=0;A(a,function(a){R(a);a.index=e++;a=a.f.cssText;for(var c;c=va.exec(a);){var d=c[1];":"!==c[2]&&(b[d]=!0)}},function(a){c.push(a)});a.b=c;a=[];for(var d in b)a.push(d);return a}
...
function T(a,b,c){b&&(b=0<=b.indexOf(";")?qb(a,b,c):Ca(b,function(b,d,f,h){if(!d)return b+h;(d=T(a,c[d],c))&&"initial"!==d?"apply-shim-inherit"===d&&(d="inherit"):d=T(a,c[f]||f,c)||f;return b+(d||"")+h}));return b&&b.trim()||""}
function qb(a,b,c){b=b.split(";");for(var e=0,d,f;e<b.length;e++)if(d=b[e]){y.lastIndex=0;if(f=y.exec(d))d=T(a,c[f[1]],c);else if(f=d.indexOf(":"),-1!==f){var h=d.substring(f);h=h.trim();h=T(a,h,c)||h;d=d.substring(0,f)+h}b[e]=d&&d.lastIndexOf(";")===d.length-1?d.slice(0,-1):d||""}return b.join(";")}
...
function sb(a,b,c,e,d){c.f||R(c);if(c.f.i){b=F(b);a=b.is;b=b.u;b=a?M(a,b):"html";var f=c.parsedSelector,h=":host > *"===f||"html"===f,g=0===f.indexOf(":host")&&!h;"shady"===e&&(h=f===b+" > *."+b||-1!==f.indexOf("html"),g=!h&&0===f.indexOf(b));"shadow"===e&&(h=":host > *"===f||"html"===f,g=g&&!h);if(h||g)e=b,g&&(c.g||(c.g=N(K,c,K.b,a?Ja+a:"",b)),e=c.g||b),d({M:e,K:g,S:h})}}
...
function ub(a,b,c,e){var d=F(b),f=M(d.is,d.u),h=new RegExp("(?:^|[^.#[:])"+(b.extends?"\\"+f.slice(0,-1)+"\\]":f)+"($|[.:[\\s>+~])");d=Q(b).j;var g=vb(d,e);return L(b,d,function(b){var d="";b.f||R(b);b.f.cssText&&(d=qb(a,b.f.cssText,c));b.cssText=d;if(!t&&!Aa(b)&&b.cssText){var k=d=b.cssText;null==b.C&&(b.C=wa.test(d));if(b.C)if(null==b.w){b.w=[];for(var q in g)k=g[q],k=k(d),d!==k&&(d=k,b.w.push(q))}else{for(q=0;q<b.w.length;++q)k=g[b.w[q]],d=k(d);k=d}b.cssText=k;b.g=b.g||b.selector;d="."+e;q=b.g.split(",");
k=0;for(var Bb=q.length,O;k<Bb&&(O=q[k]);k++)q[k]=O.match(h)?O.replace(f,d):d+" "+O;b.selector=q.join(",")}})}function vb(a,b){a=a.b;var c={};if(!t&&a)for(var e=0,d=a[e];e<a.length;d=a[++e]){var f=d,h=b;f.l=new RegExp("\\b"+f.keyframesName+"(?!\\B|-)","g");f.a=f.keyframesName+"-"+h;f.g=f.g||f.selector;f.selector=f.g.replace(f.keyframesName,f.a);c[d.keyframesName]=wb(d)}return c}function wb(a){return function(b){return b.replace(a.l,a.a)}}
function xb(a,b){var c=U,e=B(a);a.textContent=z(e,function(a){var d=a.cssText=a.parsedCssText;a.f&&a.f.cssText&&(d=d.replace(ma,"").replace(na,""),a.cssText=qb(c,d,b))})}aa.Object.defineProperties(ob.prototype,{a:{configurable:!0,enumerable:!0,get:function(){return"x-scope"}}});var U=new ob;var yb={},V=window.customElements;if(V&&!t){var zb=V.define;V.define=function(a,b,c){var e=document.createComment(" Shady DOM styles for "+a+" "),d=document.head;d.insertBefore(e,(D?D.nextSibling:null)||d.firstChild);D=e;yb[a]=e;zb.call(V,a,b,c)}};var W=new function(){this.cache={};this.a=100};function X(){var a=this;this.A={};this.c=document.documentElement;var b=new n;b.rules=[];this.l=lb(this.c,new P(b));this.v=!1;this.b=this.a=null;Ea(function(){Y(a)})}l=X.prototype;l.F=function(){kb()};l.I=function(a){return B(a)};l.O=function(a){return z(a)};
...
t||J(a.content,b);Y(this);f=y.test(d)||w.test(d);y.lastIndex=0;w.lastIndex=0;d=p(d);f&&v&&this.a&&this.a.transformRules(d,b);a._styleAst=d;a.v=e;e=[];v||(e=pb(a._styleAst));if(!e.length||v)d=t?a.content:null,b=yb[b],f=L(c,a._styleAst),b=f.length?C(f,c.is,d,b):void 0,a.a=b;a.c=e}};
...
X.prototype.flushCustomStyles=X.prototype.o;Object.defineProperties(X.prototype,{nativeShadow:{get:function(){return t}},nativeCss:{get:function(){return v}}});var Z=new X,Eb,Fb;window.ShadyCSS&&(Eb=window.ShadyCSS.ApplyShim,Fb=window.ShadyCSS.CustomStyleInterface);window.ShadyCSS={ScopingShim:Z,prepareTemplate:function(a,b,c){Z.o();Z.prepareTemplate(a,b,c)},styleSubtree:function(a,b){Z.o();Z.styleSubtree(a,b)},styleElement:function(a){Z.o();Z.styleElement(a)},styleDocument:function(a){Z.o();Z.styleDocument(a)},getComputedStyleValue:function(a,b){return Z.getComputedStyleValue(a,b)},nativeCss:v,nativeShadow:t};Eb&&(window.ShadyCSS.ApplyShim=Eb);
